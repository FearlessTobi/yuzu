...
public:
    ...
    explicit GameListDir(UISettings::GameDir& directory,
        ...
        case GameListItemType::InstalledDir:
            setData(QIcon::fromTheme("sd_card").pixmap(size), Qt::DecorationRole);
            setData("Installed Titles", Qt::DisplayRole);
            break;
        case GameListItemType::SystemDir:
            setData(QIcon::fromTheme("chip").pixmap(size), Qt::DecorationRole);
            setData("System Titles", Qt::DisplayRole);
            break;
        case GameListItemType::CustomDir:
            QString icon_name = QFileInfo::exists(game_dir->path) ? "folder" : "bad_folder";
            setData(QIcon::fromTheme(icon_name).pixmap(size), Qt::DecorationRole);
...
public:
    explicit GameListAddDir() {
        setData(type(), TypeRole);
        setData(QIcon::fromTheme("plus").pixmap(UISettings::values.icon_size), Qt::DecorationRole);
