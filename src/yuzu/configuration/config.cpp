...
void Config::ReadNetworkValues() {
    const bool missing_token =
        Settings::values.yuzu_token.empty() || Settings::values.yuzu_username.empty();

    qt_config->beginGroup(QStringLiteral("Network"));
    Settings::values.is_airplane_mode =
        ReadSetting(QStringLiteral("is_airplane_mode"), missing_token).toBool();
    qt_config->endGroup();
}
...
void Config::SaveNetworkValues() {
    ...
    qt_config->beginGroup(QStringLiteral("Network"));
    WriteSetting(QStringLiteral("is_airplane_mode"), Settings::values.is_airplane_mode.load(),
                 missing_token);
    qt_config->endGroup();
}
