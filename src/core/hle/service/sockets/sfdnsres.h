...
private:
    ...
    void ExecuteWork(Kernel::HLERequestContext& ctx, std::string sleep_reason, Work work);

    Core::System& system;

    BlockingWorkerPool<SFDNSRES, GetHostByNameWork, GetAddrInfoWork, GetHostByNameWithOptionsWork,
                       GetAddrInfoWithOptionsWork>
        worker_pool;
