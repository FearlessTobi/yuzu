...
NCA::NCA(VirtualFile file_, Core::Crypto::KeyManager keys_, VirtualFile bktr_base_romfs_,
         u64 bktr_base_ivfc_offset)
    : file(std::move(file_)), keys(std::move(keys_)), bktr_base_romfs(std::move(bktr_base_romfs_)) {
    if (file == nullptr) {
